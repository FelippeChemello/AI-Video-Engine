...
import { Speaker, SynthesizedAudio, TTSClient, voices as voicesMap } from './interfaces/TTS';
import path from 'path';
import { publicDir } from '../config/path';
import { sanitizeText } from '../utils/sanitize-text';

export class QwenClient implements TTSClient {
    async synthesize(voice: Speaker, text: string, id?: string | number): Promise<SynthesizedAudio> {
